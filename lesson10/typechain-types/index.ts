...
export type { IMyERC20Token } from "./contracts/TokenSale.sol/IMyERC20Token";
export { IMyERC20Token__factory } from "./factories/contracts/TokenSale.sol/IMyERC20Token__factory";
